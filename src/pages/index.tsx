...
export default function LandingPage() {
  ...
  return (
    <main className="flex flex-col h-fit w-screen relative text-typography-primary">
      ...
      <div className="bg-background-purple flex flex-col w-full h-fit pt-[66px]">
        <section className="bg-white rounded-t-[34px] flex h-fit flex-col items-center relative">
          <figure className="absolute -top-20 my-4 scrollbar-hide overflow-auto flex gap-2 snap-x snap-mandatory">
          ...
          <section className="flex flex-col w-full h-full mt-[132px]">
